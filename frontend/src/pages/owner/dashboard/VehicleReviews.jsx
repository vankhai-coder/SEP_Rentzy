...
const VehicleReviews = () => {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Đánh giá về xe của tôi</h1>
        <p className="text-gray-600">Xem và theo dõi các đánh giá từ khách hàng</p>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            <div className="text-center">
              <div className="text-4xl font-bold text-gray-900">{Number.isFinite(avgRating) ? avgRating.toFixed(1) : '0.0'}</div>
      ...
      <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
        ...
        {reviews.length === 0 ? (
          <div className="px-6 py-12 text-center">
            <MdStar className="mx-auto h-12 w-12 text-gray-400" />
            <h3 className="mt-2 text-sm font-medium text-gray-900">Không có đánh giá nào</h3>
            <p className="mt-1 text-sm text-gray-500">Chưa có đánh giá nào từ khách hàng.</p>
          </div>
        ) : (
