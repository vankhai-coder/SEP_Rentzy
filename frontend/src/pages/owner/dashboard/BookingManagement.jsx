...
const BookingManagement = () => {
  ...
  const statusColors = {
    ...
    'rental_paid': 'bg-green-100 text-green-800',
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Quản lý đơn thuê</h1>
        <p className="text-gray-600">Theo dõi và quản lý các đơn thuê xe của bạn</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">Danh sách đơn thuê</h3>
        </div>
        ...
        {bookings.length === 0 ? (
          <div className="px-6 py-12 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Không có đơn thuê nào</h3>
            <p className="mt-1 text-sm text-gray-500">Chưa có đơn thuê nào được tạo.</p>
          </div>
        ) : (
                ...
                {bookings.map((booking) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-sm text-gray-500">
                        đến {formatDateTime(booking.end_date, booking.end_time)}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">
